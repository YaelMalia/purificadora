...
if($getMesg =="Quiero hacer un pedido" || $getMesg =="Hacer pedido" || $getMesg =="Pedido" || $getMesg =="pedido")
{
    echo "Con gusto te atenderemos, realiza tu pedido en el siguiente enlace
    
    </br><a href='sendEmail.php'>Contacto</a>";
}
else
{
    if (mysqli_num_rows($run_query) > 0) {
        ...
        echo "¡Lo siento, no puedo ayudarte con esa información! :(";
