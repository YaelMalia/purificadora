        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <!-- <a href="#Instalaciones" class="nav-item nav-link">Instalaciones</a> -->
                    ...
                    ?>
                    <?php 
                        if(isset($_SESSION["correo"]) && !isset($_COOKIE["cookieCorreo"])){
                    ?>
    ...
    <div id = "contenido" class="contenido">
       ...
       <center>
        ...
        <div class="segundo-apartado">
            ...
            <div class="s-part">
                <p><h3>Ubicación del lugar</h3></p>
                <iframe class="GMaps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15029.674839576774!2d-98.54051700429989!3d19.65213413401917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1cb8817d4dce3%3A0x501417e8b1b4deaf!2sAbasolo%2028B%2C%20Centro%2C%2043960%20Centro%2C%20Hgo.!5e0!3m2!1ses!2smx!4v1663625227309!5m2!1ses!2smx" width="400" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<footer>
    <div id = "footer" class = "footer">
        <div class="izq">
            <img class = "logo_lux" src="sources/images/LogoEmpresa.png" width="120px" height="70px" alt="LUX Enterprise" style="margin-right: 20px; ">
                <br>
                <br> 
        ...
        <div class="der">
            ...
            <br>
            <br>
            <img class = "logo_gmail" src="sources/images/gmail.png" width = "50px" height = "50px"alt="gmail" style="margin-right: 20px; ">
            <br>
            Correo de contacto: <a href="mailto:lux.enterprise01@gmail.com" target="_blank">lux.enterprise01@gmail.com</a>
        </div>
    </div>
</footer>
</html>